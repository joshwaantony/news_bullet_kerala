...
export default function Navbar() {
  ...
  const normalClass =
    "text-black font-medium hover:text-orange-600 transition";
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full z-50 bg-white shadow-md transition-all duration-300 ${visible ? "translate-y-0" : "-translate-y-full"
          }`}
      >
