...
//       {/* ========== TOPBAR ========== */}
//       <header
//         className="h-16 bg-white shadow-md flex items-center justify-between 
//         px-4 sm:px-6 sticky top-0 z-40"
//       >
//         {/* Left: Title */}
//         <h3 className="text-lg sm:text-xl font-extrabold text-[#563D2F] tracking-wide">
//           Admin Dashboard
//         </h3>
...
//             bg-white/70 backdrop-blur rounded-xl shadow hover:shadow-md transition"
//           >
//             <img
//               src="/logo.jpg"
...
//             } absolute right-0 mt-2 w-44 bg-white shadow-xl rounded-xl p-2 
//             border border-gray-100 animate-slideDown hidden sm:block`}
//           >
//             <button
//               className="w-full flex items-center gap-3 px-3 py-2 rounded-lg 
//               hover:bg-gray-100 text-gray-700 text-sm"
...
//       {dropdown && (
//         <div className="sm:hidden fixed inset-0 bg-black/30 backdrop-blur-sm z-40 flex">
//           <div className="bg-white w-full p-6 rounded-b-2xl shadow-lg animate-slideDownMobile">

//             {/* Sheet Options */}
//             <button
//               className="w-full flex items-center gap-3 px-3 py-3 rounded-lg 
//               border-b text-gray-700 text-base"
//             >
//               <FaUser /> Profile
//             </button>
...
//               className="mt-3 w-full text-center py-2 text-gray-500"
//             >
//               Cancel
//             </button>
//           </div>
...
//       {showConfirm && (
//         <div
//           className="fixed inset-0 bg-black/40 backdrop-blur flex items-center 
//         justify-center z-50 animate-fadeIn"
//         >
//           <div
//             className="bg-white mx-4 w-full max-w-sm rounded-xl shadow-2xl 
//           p-6 animate-scaleIn"
//           >
...
//               <button
//                 onClick={handleLogout}
//                 className="px-4 py-2 rounded-lg bg-gradient-to-r from-orange-500 
//                 to-orange-700 text-white text-sm shadow hover:opacity-90"
//               >
//                 Logout
//               </button>
//             </div>
...
import { useAuthStore } from "@/store/authStore";
import { useRouter } from "next/navigation";
import { FaChevronDown, FaSignOutAlt, FaUser, FaBars } from "react-icons/fa";
...
export default function Topbar({ setSidebarOpen }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="sm:hidden text-xl text-[#563D2F]"
          >
            <FaBars />
          </button>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {dropdown && (
            <div
              className="absolute right-0 mt-2 w-44 bg-white shadow-xl rounded-xl p-2 
              border border-gray-100 animate-slideDown hidden sm:block"
            >
              <button
                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg 
      ...
      {dropdown && (
        <div className="sm:hidden fixed inset-0 bg-black/30 backdrop-blur-sm z-40 flex">
          <div className="bg-white w-full p-6 rounded-b-2xl shadow-lg animate-slideDownMobile">
            ...
            <button className="w-full flex items-center gap-3 px-3 py-3 border-b text-gray-700 text-base">
              <FaUser /> Profile
            </button>
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-3 text-red-600 text-base"
            >
              <FaSignOutAlt /> Logout
            </button>
      ...
      {/* ----- LOGOUT CONFIRM MODAL ----- */}
      {showConfirm && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur flex items-center 
        justify-center z-50 animate-fadeIn">
          <div
            className="bg-white mx-4 w-full max-w-sm rounded-xl shadow-2xl 
          p-6 animate-scaleIn"
